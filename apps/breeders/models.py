...
class Breed(models.Model):
    ...
    front_photo = models.URLField(null=True, blank=True)
    side_photo = models.URLField(null=True, blank=True)
    back_photo = models.URLField(null=True, blank=True)
    ...
    def get_absolute_url(self):
        return '/breed/{}'.format(self.code) #cloudinary
...
class Breeders(models.Model):
    ...
    hens_photo = ProcessedImageField(upload_to='breeders_photos',null=True,blank=True, processors=[ResizeToFit(1280)], format='JPEG', options={'quality': 70}) #to_do- cloudinary image
